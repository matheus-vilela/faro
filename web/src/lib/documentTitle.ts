...
export function getDocumentTitle(pathname: string): string {
  ...
  const underApp: { prefix: string; label: string }[] = [
    ...
    { prefix: "/app/produtos/correlacao-2", label: "Correlação 2" },
    ...
    { prefix: "/app/checklists/historico", label: "Histórico" },
    { prefix: "/app/checklists/conferencia", label: "Conferência" },
    { prefix: "/app/checklists/ranking", label: "Ranking" },
