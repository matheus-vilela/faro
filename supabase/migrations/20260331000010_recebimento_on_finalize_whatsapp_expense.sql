-- Ao finalizar despesa pelo link WhatsApp, criar card de recebimento (mesmo comportamento da tela Despesas).
...
-- Despesas existentes sem card (ex.: criadas antes desta correção)
INSERT INTO public.recebimentos (expense_id)
SELECT e.id
