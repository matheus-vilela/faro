-- Corrige chamada pg_net: usar net.http_post com body jsonb (não extensions.http_post com body text).
...
comment on function public.cron_invoke_focus_get_sync_nfe_interpret() is
  'pg_cron: POST para Edge interpret staging (secrets Vault: focus_interpret_cron_*). Usa net.http_post (pg_net).';
