-- Correlação: total de compras sem utilização (ficha) para alerta no Dashboard.
...
COMMENT ON FUNCTION public.dashboard_product_recipe_match_lists(UUID, INT, INT, INT, INT) IS
  'Dashboard correlação: purchases/sold_only com limit/offset, totals e purchases_without_util_total; ignora merge sintético.';
