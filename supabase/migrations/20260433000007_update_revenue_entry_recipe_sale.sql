-- Atualiza create companion: update_revenue_entry com recipe_sale (estorno + nova baixa).
...
COMMENT ON FUNCTION public.update_revenue_entry(jsonb) IS
  'Atualiza receita; taxa por categoria. Venda de produto ou receita (ficha); CMV quando aplicável.';
