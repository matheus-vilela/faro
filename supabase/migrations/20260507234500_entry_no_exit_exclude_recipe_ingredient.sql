-- Entrada sem saída: sair da fila também quando o produto já é insumo de alguma ficha (receita) da empresa.
...
COMMENT ON FUNCTION public.dashboard_import_review_entry_no_exit_list(UUID) IS
  'Dashboard: produtos com entrada de compra/import e sem saída; exclui dispensados, produto de saída de receita, insumo em receita da empresa, e abrir fluxo de ficha (LINK_RECIPE_STARTED) não remove da fila.';
