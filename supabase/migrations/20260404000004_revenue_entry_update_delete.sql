-- Exclusao e atualizacao de receitas: estorno/reaplicacao de estoque e recriacao de boletos a receber.
...
COMMENT ON FUNCTION public.delete_revenue_entry(UUID) IS
  'Remove receita, boletos vinculados (cascade) e estorna estoque em venda de produto.';

GRANT EXECUTE ON FUNCTION public.delete_revenue_entry(UUID) TO authenticated;
