-- A logica desta funcao foi incorporada ao *inicio* de
-- 20260404000005_revenue_tax_boleto_payable.sql (antes do UPDATE dos boletos),
-- porque o UPDATE dispara o trigger e falhava com a versao antiga.
-- Mantemos aqui o mesmo CREATE OR REPLACE para idempotencia e para ambientes
-- que possam ter aplicado apenas 006.
