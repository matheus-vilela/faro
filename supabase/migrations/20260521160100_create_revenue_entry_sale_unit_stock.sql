-- Baixa de estoque em venda na unidade do produto; quantity na receita permanece na unidade informada (ex.: UN EPOC).
...
COMMENT ON FUNCTION public.create_revenue_entry(jsonb) IS
  'Insere receita e boletos; baixa estoque convertendo sale_unit_code (padrao un) para products.unit. EPOC/CSV: _csv_import_job_id.';
