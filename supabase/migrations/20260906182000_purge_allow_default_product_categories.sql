-- Purga: permite apagar categorias de produto padrao_sistema (mesmo bypass da exclusão da empresa).
...
BEGIN
  ...
  DELETE FROM public.purge_company_opdata_last_run WHERE id IS NOT NULL;
