/**
 * Equivalência / merge de produtos no onboarding (catálogo a partir das NF-e).
 * Consumidor: `run-onboarding-product-reconciliation`; reexport em `onboardingProductReconciliation/aiPrompt.ts`.
 */
